...
from utilities import is_linux, is_macos, is_windows
...
class InputController:
    ...
    def _initialize_backend(self, backend, **kwargs):
        if backend == InputControllers.CLIENT:
            from input_controllers.client_input_controller import ClientInputController
            return ClientInputController(game=self.game, **kwargs)
        elif backend == InputControllers.PYAUTOGUI:
            from input_controllers.pyautogui_input_controller import PyAutoGUIInputController
